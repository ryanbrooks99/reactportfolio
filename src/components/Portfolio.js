    ...
    return (
        <>
            <Container>
                <Row>
                    <Col xs={6} md={4}>
                        <Image width="100%" src="./assets/images/musiquery.png" rounded />
                    ...
                    <Col xs={6} md={4}>
                        <Image width="100%" src="./assets/images/cocktellme.png" rounded />
                    ...
                    <Col xs={6} md={4}>
                        <Image width="100%" src="./assets/images/dayplanner.png" rounded />
                ...
                <Row>
                    <Col xs={6} md={4}>
                        <Image width="100%" src="./assets/images/eatdaburger.png" rounded />
                    ...
                    <Col xs={6} md={4}>
                        <Image width="100%" src="./assets/images/codequiz.png" rounded />
                    ...
                    <Col xs={6} md={4}>
                        <Image width="100%" src="./assets/images/weatherdashboard.png" rounded />
